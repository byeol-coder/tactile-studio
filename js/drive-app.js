...
import * as DriveUI from './drive-ui-shared.js';
...
function renderCard(a) {
  return DriveUI.renderAssetCard(a, { mode: 'browse' });
}
...
function emptyStateHtml() {
  return DriveUI.emptyStateHtml();
}

function assetGridHtml(list, loading) {
  return DriveUI.assetGridHtml(list, loading, { mode: 'browse' });
}
...
function filterPanelHtml(resultCount) {
  return DriveUI.filterPanelHtml(state, resultCount);
}

/* ── Home view ───────────────────────────────────────────────── */
function categoryChipsHtml() {
  return DriveUI.categoryChipsHtml(state);
}
